...
public class FontFamilyStyleGenerator implements CodeGenerator {
    ...
    @Override
    public void generate(FontFamily fontFamily, File outputDir) throws ParserConfigurationException, TransformerException {
        transformer.transform(generate(fontFamily), new StreamResult(new File(outputDir, getFileName(fontFamily, FileType.XML))));
    }
