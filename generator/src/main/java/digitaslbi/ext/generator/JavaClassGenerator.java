...
import static digitaslbi.ext.common.FontUtils.nameToStyleName;
import static digitaslbi.ext.common.FontUtils.styleNameToName;
import static digitaslbi.ext.generator.Streams.asByteSink;


/**
 * Represents a code {@link Generator} which generates a Java class for a {@link FontFamily}.
 */
public class JavaClassGenerator implements Generator {
    ...
    @Override
    public void generate(FontFamily fontFamily, File file) throws IOException {
        generate(fontFamily).writeTo(file);
    }
