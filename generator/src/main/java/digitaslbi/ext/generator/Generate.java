...
public class Generate {
    ...
    private static void processFiles(File inputDir, String outputPath, String packageName) throws Exception {
        ...
        new FileProcessor(new JavaClassGenerator(packageName)).generate(inputDir, classOutputDir);
        new FileProcessor(new XmlResourceGenerator()).generate(inputDir, resOutputDir);
    }
}
