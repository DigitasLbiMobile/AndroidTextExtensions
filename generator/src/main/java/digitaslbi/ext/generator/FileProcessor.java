...
import static digitaslbi.ext.common.FontUtils.capitalize;
import static digitaslbi.ext.common.FontUtils.cleanupFontName;
import static digitaslbi.ext.generator.Constants.ACCEPTED_FONTS_EXTENSIONS;

/**
 * Processes a directory, usually the `assets` folder and calls a code {@link Generator} to create either Java classes
 * or XML resources.
 */
public class FileProcessor {
    ...
    public FileProcessor(Generator generator) {
    ...
    protected void process(String fileName, Map<String, FontFamily> map) {
        ...
        final Font font = new Font(cleanupFontName(nameWithoutExtension), fileName);
    ...
    private void output(List<FontFamily> families, File file, Appendable appendable) throws Exception {
    ...
    public static String getFontFamilyName(String fileName) {
        ...
        return capitalize(Splitter.on(anyOf(FontUtils.ASSET_SEPARATORS))
                .trimResults()
                .omitEmptyStrings()
                .limit(FontUtils.NAME_PARTS)
