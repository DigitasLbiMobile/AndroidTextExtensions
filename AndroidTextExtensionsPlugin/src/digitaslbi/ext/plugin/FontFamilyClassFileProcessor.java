 ...
 */
public class FontFamilyClassFileProcessor extends VirtualFileProcessor {

    private static final String JAVA_PACKAGE = "java";

    public FontFamilyClassFileProcessor(CodeGenerator generator, BootstrapClassGenerator bootstrapClassGenerator, Project project) {
