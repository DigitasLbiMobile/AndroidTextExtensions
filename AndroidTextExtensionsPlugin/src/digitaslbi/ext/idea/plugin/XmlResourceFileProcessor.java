...
import static digitaslbi.ext.generator.Constants.*;
 ...
 */
public class XmlResourceFileProcessor extends VirtualFileProcessor {

    public XmlResourceFileProcessor(Generator generator, Project project) {
